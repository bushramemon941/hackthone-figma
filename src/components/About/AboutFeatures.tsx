...
const AboutFeatures = () => {
  return (
    <div className="relative w-[390px] md:w-[1440px] md:h-[598px] h-[628px] flex flex-col md:flex-row p-6 gap-4 mt-[5rem]">
      <div className="md:w-[634px] md:h-[478px] bg-[#2A254B] p-8">
        ...
        <button className="w-full md:relative md:w-[188px] md:left-[3rem] md:top-[10rem] py-[16px] px-[32px] bg-[#f9f9f9] bg-opacity-[15%] leading-6 text-white font-satoshi font-normal hover:bg-[#F9F9F9] hover:text-[#22202E] transition-all duration-300 ease-in-out">
          View collection
        </button>
      </div>
      <div className="md:w-[630px]">
        <Image
          src="/imgs/yellowSofa.png"
          alt="Yellow Sofa"
          width={200}
          height={200}
