...
const AboutGetInTouch = () => {
  return (
    <div className="relative w-[390px] h-[836px] md:w-[1440px] md:h-[603px] bg-[#F9F9F9] flex top-[14rem] flex-col-reverse md:flex-row-reverse md:top-[8rem]">
      <div className="flex flex-col gap-[16px] p-4 md:w-[720px] mt-[5rem] px-8 md:px-[7rem]">
        ...
        <div className="relative flex md:top-[3rem] md:right-[6rem] justify-center">
          <button className=" mt-[6rem] mb-8 w-[309px] py-[16px] px-[32px] bg-white bg-opacity-[15%] leading-6 text-[#2a254b] font-satoshi font-normal hover:bg-[#2A254B] shadow border border-[#2A254B] hover:text-white transition-all duration-300 ease-in-out text-lg">
            Get in touch
          </button>
        </div>
      </div>
