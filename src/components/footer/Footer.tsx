...
const Footer = () => {
  return (
    <div className="relative md:w-[1440px] md:h-[300] w-[390px] h-[720px] bottom-4  gap-8 md:py-[6rem] md:px-[2rem] bg-[#2A254B]">
      <div className="flex flex-col lg:flex-row md:border-b md:border-[#4e4d93] ">
        ...
        <div className="md:relative md:left-[4rem] md:top-[3rem]">
          ...
          <div className="mt-4 flex justify-center pb-6 border-b border-[#4e4d93] md:border-[#2A254B]   ">
            <input
              type="email"
            ...
            />
            <button className="px-[32px] py-[16px] bg-white text-[#2A254B] font-satoshi font-normal leading-6 hover:bg-[#726E8D] hover:text-[#F9F9F9]">
              Sign up
            </button>
          </div>
        </div>
      </div>
      <div className="md:flex md:justify-between bg-[#2A254B]">
