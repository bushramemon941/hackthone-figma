    ...
    <div className="relative w-[390px] h-[828px] md:w-[1440px] md:h-[603px] bg-white mt-[4rem]flex flex-col md:flex-row md:top-[7rem]">
      <div className="flex flex-col gap-[16px] p-4 md:w-[720px]">
        ...
        <div className="relative flex md:top-[4.5rem] justify-start">
          <button className=" mt-[6rem] mb-8 w-[309px] py-[16px] px-[32px] bg-[#F9F9F9] bg-opacity-[15%] leading-6 text-[#2a254b] font-satoshi font-normal hover:bg-[#2A254B] hover:text-white transition-all duration-300 ease-in-out text-lg">
            Get in touch
          </button>
        </div>
      </div>
