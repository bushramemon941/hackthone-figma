...
const Hero = () => {
  return (
    <div className="relative w-[390px] h-[502px] md:w-[1280px] md:h-[584px] md:my-[6rem] md:mx-[4.5rem] bg-[#2A254B] flex flex-col md:flex-row gap-[2rem]">
      <div className="">
        ...
        <div className="px-8  font-normal flex flex-col gap-10">
          ...
          <p className="leading-[27px] md:relative md:top-[13rem] md:left-2 md:w-[602px] text-white text-lg bg-[#2A254B] ">
