...
const PopularProducts = () => {
  return (
    <div className="relative mt-[14rem] mx-[1.5rem] w-[390px] h-[573px] md:w-[1440px] md:h-[744px] bg-white">
      <h4 className="relative my-4 pl-4 font-clash font-normal leading-[24.6px] text-[#2A254B] text-lg md:text-4xl md:bottom-[10rem]">
      ...
      <div className="relative hidden md:bottom-[8rem] md:w-[1440px] md:h-[375px] md:flex gap-[30px] group">
        ...
        >
          ...
          <div className="flex flex-col gap-[8px]">
            <h4 className="font-clash font-normal leading-7 text-[#2A254B] md:text-xl">
              The Poplar suede sofa
            </h4>
            <p className="font-satoshi font-normal leading-[27px] text-[#2A254B] md:text-xl">
              &pound; 980
            </p>
          </div>
      ...
      <div className="relative md:right-[4rem] md:top-[4rem] flex md:justify-center">
        <button className=" m-2 mt-4 w-[309px] py-[16px] px-[32px] bg-[#F9F9F9] bg-opacity-[15%] leading-6 text-[#2a254b] font-satoshi font-normal hover:bg-[#2A254B] hover:text-white transition-all duration-300 ease-in-out text-lg">
          View collection
        </button>
      </div>
    </div>
