...
const SignUp = () => {
    return (
      <div className="relative md:right-[10rem] w-[390px] h-[292px] md:w-[1440px] md:h-[481px] md:mt-[8rem] md:border-[3.5rem] md:left-[1rem] md:border-[#F9F9F9] bg-white p-4 bottom-[5rem]">
        ...
        <div className="md:relative mt-[6rem] flex md:justify-center">
          ...
          />
          <button className="px-[32px] py-[16px] bg-[#2A254B] text-white font-satoshi font-normal leading-6 hover:bg-[#726E8D] hover:text-[#2A254B]">
            Sign up
          </button>
        </div>
      </div>
