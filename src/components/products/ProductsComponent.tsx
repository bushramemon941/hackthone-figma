    ...
    <div className="flex flex-col md:w-[1440px] md:h-[2439px]">
      ...
      <div className="h-[96px] flex gap-4 justify-center my-[4rem] md:hidden relative">
        ...
        <div className="relative">
          <button
            className="w-[143px] h-[56px] flex items-center justify-center px-4 py-2 shadow-sm bg-[#F9F9F9] hover:bg-[#2A254B] hover:text-white transition text-[#22202E]"
          ...
          {isFilterOpen && (
            <div className="absolute top-12 left-0 w-40 bg-white border border-gray-300 rounded-lg shadow-lg z-10">
              <ul className="text-[#22202E] text-sm">
      ...
      <div className="hidden md:flex w-[1440px] justify-between items-center px-4 py-4 bg-[#F9F9F9]">
        {/* Left Side Filters */}
          ...
          <div className="relative bottom-[35rem]">
            ...
            {isFilterOpen && (
              <div className="absolute top-12 hidden bg-white border border-gray-300 rounded-lg shadow-lg z-10 group-hover:block">
                <ul className="text-sm text-[#22202E]">
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
                    Furniture
                  </li>
                  <li className="px-4 py-2 hover:bg-gray-100 cursor-pointer">
      ...
      <div className="px-[2rem]">
        <button className="w-full md:relative mt-[12rem] md:bottom-[4rem] md:left-[36rem] md:mt-0 md:w-[200px] md:h-[56px] py-[16px] px-[32px] bg-[#F9F9F9] bg-opacity-[15%] leading-6 text-[#2A254B] font-satoshi font-normal hover:bg-[#2A254B] hover:text-white transition-all duration-300 ease-in-out">
